...
-   In general, instructors or programs may not require learners to sign up for any technology service for which the learner must pay a fee. Exceptions, subject to approval by a dean or department chair and the Office of the Provost, must meet the same standards described above for required hardware and software purchases.
